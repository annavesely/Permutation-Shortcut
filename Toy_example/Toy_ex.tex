...
After 3 steps, $S$ is rejected in the subspace $\mathbb{S}_{+5}$. Subsequently, after 3 other steps, it is not rejected in $\mathbb{S}_{-5}$. In conclusion, it is not rejected after 6 steps.
...
\node (n2) [c-rectangle2, below of=n1, xshift=2.2cm] {Step 2\\
\begin{tabular}{cc}
\toprule
$v$ & 2\\
\midrule
...
\node (n3) [c-rectangle2, below of=n1, xshift=-2.2cm] {Step 3\\
\begin{tabular}{cc}
\toprule
$v$ & 2 \\
\midrule
...
\node (n4) [c-rectangle2, below of=n0, xshift=-4.4cm] {Step 4\\
\begin{tabular}{ccc}
\toprule
$v$ & 1 & 2 \\
\midrule
...
\node (n5) [c-rectangle2, below of=n4, xshift=2.2cm] {Step 5\\
\begin{tabular}{cc}
\toprule
$v$ & 1 \\
\midrule
...
\node (n6) [c-rectangle2, below of=n4, xshift=-2.2cm] {Step 6\\
\begin{tabular}{cc}
\toprule
$v$ & 1 \\
\midrule
...
\draw [arrow] (n4) -- node[anchor=west] {+(2)} (n5);
\draw [arrow] (n4) -- node[anchor=east] {-(2)} (n6);
\end{tikzpicture}
\end{figure}
